...
_CRITERIA: tuple[AcceptanceCriterion, ...] = (
    ...
    AcceptanceCriterion(
        ...
        next_action="Add controlled create/edit forms for tenant and engagement records.",
    ),
    AcceptanceCriterion(
    ...
    AcceptanceCriterion(
        ...
        required_for_p1=False,
        evidence=("masterblaster_control/runner_simulator.py", "tests/test_runner_simulator.py"),
        next_action="Add HTTP headers and certificate-expiry fixture scenarios.",
    ),
    AcceptanceCriterion(
        ...
        next_action="Replace SBOM stub with signed release artifacts once packaging lands.",
    ),
    AcceptanceCriterion(
        ...
        percent=100,
        required_for_p1=True,
        evidence=("docs/REVIEW_POLICY.md", ".github/CODEOWNERS"),
        next_action="Enable branch protection to enforce CODEOWNERS on the default branch.",
    ),
    AcceptanceCriterion(
    ...
    AcceptanceCriterion(
        ...
        next_action="Add export and deep-link actions from audit rows to evidence detail panes.",
    ),
)
