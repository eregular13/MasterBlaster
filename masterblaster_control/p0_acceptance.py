...
_CRITERIA: tuple[AcceptanceCriterion, ...] = (
    ...
    AcceptanceCriterion(
        ...
        percent=85,
        required_for_p1=True,
        evidence=("masterblaster_control/p0_storage.py", "tests/test_p0_storage.py"),
        next_action="Add retention and redaction controls.",
    ),
    AcceptanceCriterion(
    ...
    AcceptanceCriterion(
        ...
        percent=0,
        required_for_p1=True,
        evidence=("docs/P0_ACCEPTANCE_CHECKLIST.md",),
        next_action="Implement draft approval request states: requested, approved, denied, expired.",
    ),
    AcceptanceCriterion(
        ...
        evidence=("masterblaster_control/p0_storage.py",),
        next_action="Add a read-only browser, then controlled create/edit forms.",
    ),
    AcceptanceCriterion(
    ...
    AcceptanceCriterion(
        ...
        required_for_p1=False,
        evidence=("masterblaster_control/runner_simulator.py",),
        next_action="Add HTTP headers, DNS posture, and certificate-expiry fixture scenarios.",
    ),
    AcceptanceCriterion(
        ...
        required_for_p1=True,
        evidence=("docs/P0_ACCEPTANCE_CHECKLIST.md",),
        next_action="Add GitHub Actions workflow plus generated SBOM placeholder.",
    ),
    AcceptanceCriterion(
        ...
        required_for_p1=True,
        evidence=("docs/P0_ACCEPTANCE_CHECKLIST.md",),
        next_action="Add CODEOWNERS-style policy documentation.",
    ),
    AcceptanceCriterion(
        ...
        percent=0,
        required_for_p1=True,
        evidence=("docs/architecture/p0-storage.md",),
        next_action="Add redaction helpers and retention settings.",
    ),
    AcceptanceCriterion(
        ...
        percent=40,
        required_for_p1=False,
        evidence=("masterblaster_control/main_window.py",),
        next_action="Add filterable audit/evidence table widgets.",
    ),
)
