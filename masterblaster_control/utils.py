    ...
    with path.open("w", encoding="utf-8") as report_file:
        if watermark:
            try:
                ...
                report_file.write(f"# {cfg.report_watermark}\n")
                report_file.write(f"# Prepared by {cfg.firm_name}\n\n")
            except Exception:
                report_file.write("# CONFIDENTIAL — Authorized Security Assessment Report\n\n")
