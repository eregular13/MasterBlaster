...
def list_phase_progress() -> tuple[PhaseProgress, ...]:
    ...
    return (
        ...
        PhaseProgress(
            ...
            "complete",
            (),
            "v1.0.0 release, MCP stdio/HTTP, auth, pen-test pack, Pages, installer CI.",
        ),
        PhaseProgress(
            "P9",
            ...
            75,
            "in_progress",
            ("codesigned_installer", "oidc_token_exchange"),
            "A7 flag, HSM, OIDC, plugin review queue, fuzz tests, release automation.",
        ),
        PhaseProgress(
            "P10",
            "v2 community forge",
            20,
            "in_progress",
            ("discord_launch", "marketplace_beta"),
            "v2 roadmap, marketplace skeleton, demo video script, Discord scaffold.",
        ),
    )
